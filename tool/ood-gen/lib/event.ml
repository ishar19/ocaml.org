...
| Some utc_hh_mm ->
Syndic.Date.of_rfc3339 (event.starts.yyyy_mm_dd ^ "T" ^ utc_hh_mm ^ ":00-00:00")
| None ->
Syndic.Date.of_rfc3339 (event.starts.yyyy_mm_dd ^ "T00:00:00-00:00")
in
Syndic.Atom.entry ~content ~id ~authors ~title:(Syndic.Atom.Text event.title)
~updated ~links:[ Syndic.Atom.link id ] ()
